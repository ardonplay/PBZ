...
CREATE TABLE
    TEACHER_TEACHES_SUBJECTS_IN_GROUPS (
        id VARCHAR(4) REFERENCES STUDENT_GROUP(id),
        name VARCHAR(255) REFERENCES SUBJECT(id),
        personalId VARCHAR(4) REFERENCES TEACHER(id),
        audienceNumber INT NOT NULL,
        PRIMARY KEY (id, name, personalId)
    );
