...
import { setSelectedRow, waybillRow, setEditDialogOpen, deleteWaybill, updateWaybill, setAddProductToWaybillDialogOpen, deleteProductFromWaybill } from '@slices/waybillsSlice';
...
export default function WaybillEditModal() {

    const dispatch = useAppDispatch();

    const data = useAppSelector((state) => state.waybills.selectedRow) as waybillRow;

    const dialogOpen = useAppSelector((state) => state.waybills.editDialogOpen) as boolean;
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex space-x-5 mt-4">
                            <DeleteButton onClick={() => { dispatch(deleteWaybill(data)) }} />
                            <SaveButton onClick={() => dispatch(updateWaybill(data))} />
                        </div>
                    </div>
                </div>
            </div>
