export default function Selector(props: { onChange: Function, value: string, values: string[], placeHolder: string }) {
    return (
        <div class="col-span-4">
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{props.placeHolder}</label>
            <select
